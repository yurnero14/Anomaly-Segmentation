...
def main(args):
    ...
    image_path = os.path.join(args.datadir, 'leftImg8bit/val/frankfurt/frankfurt_000000_000294_leftImg8bit.png')
    ...
    plt.subplots_adjust(top=0.5,bottom=0.0)  # Adjust this value as needed, is in inches
        
        
    ax[0].imshow(image[0,...].permute(1,2,0))
    ax[0].set_title("image")
    ax[1].imshow(label_color.permute(1,2,0))
